...
import { ChevronLeft, Plus, UploadCloud } from "lucide-react";
...
function buildInitialState(initialProduct?: AdminProduct): ProductFormState {
  ...
  return {
    ...
    featuresInput: (initialProduct?.features || []).join(", "),
    specs: {
          ...
          <CardContent className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              ...
              <div className="md:col-span-2 border-t pt-4">
                <h3 className="font-semibold text-black mb-3">Descriptions</h3>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="md:col-span-2">
                    ...
                    <input
                      ...
                      onChange={(event) =>
                        setField("featuresInput", event.target.value)
                      }
                      placeholder="Comma separated, e.g. Thunderbolt 4, WiFi 6, Premium Build"
                      className={inputCls}
                    />
                  </div>
                  <div className="md:col-span-2">
              ...
              <div className="md:col-span-2 border-t pt-4">
                ...
                <div className="space-y-4 rounded-2xl border border-gray-200 bg-linear-to-b from-white to-gray-50 p-4 md:p-5">
                  <div
